...
shaka.offline.electron.StorageMechanism = class {
   ...
   */
  async destroy() {
    if (this.dlmStorage && this.dlmStorage.manager) {
      console.log("StorageMechanism::destroy()");
      this.dlmStorage.manager.clear();
    }
  }
  ...
  async erase() {
    ...
    if (this.dlmStorage.manager) this.dlmStorage.manager.clearAll();
