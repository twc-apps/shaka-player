...
goog.provide('shaka.offline.electron.V1StorageCell');
 ...
 */
shaka.offline.electron.V1StorageCell = class {
  /**
  ...
  constructor(connection, segmentStore, manifestStore) {
    /** @private {!shaka.offline.electron.DBConnection} */
    this.connection_ = new shaka.offline.electron.DBConnection(connection);
  ...
  getSegments(keys) {
    const convertSegmentData =
        shaka.offline.electron.V1StorageCell.convertSegmentData_;
  ...
  getManifests(keys) {
    const convertManifest =
        shaka.offline.electron.V1StorageCell.convertManifest_;
  ...
  static convertManifest_(old) {
    ...
    const convertPeriod = shaka.offline.electron.V1StorageCell.convertPeriod_;
  ...
  static convertPeriod_(old) {
    ...
    const convertStream = shaka.offline.electron.V1StorageCell.convertStream_;
    const fillMissingVariants =
        shaka.offline.electron.V1StorageCell.fillMissingVariants_;
  ...
  static convertStream_(old) {
    ...
    const getKeyFromUri =
        shaka.offline.electron.V1StorageCell.getKeyFromSegmentUri_;
    const convertSegment =
        shaka.offline.electron.V1StorageCell.convertSegment_;
  ...
  static convertSegment_(old) {
    ...
    const V1StorageCell = shaka.offline.electron.V1StorageCell;
